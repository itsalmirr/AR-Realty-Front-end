...
export { default as PatternDecor } from '@components/PatternDecor'
...
export { default as ContactFormDecor } from '@components/ContactFormDecor'
export { default as ContactFormDotDecor } from '@components/ContactFormDotDecor'
