      ...
      <div data-aos='fade-up' className='-mt-px w-0 flex-1 flex'>
        {prevPage && (
          <button
            ...
            className='border-t-2 border-transparent pt-4 pr-1 inline-flex items-center text-sm font-medium dark:text-gray-400 dark:hover:text-gray-200 dark:hover:border-gray-200 text-gray-500 hover:text-gray-700 hover:border-gray-300'
          >
            <FaArrowLeft
