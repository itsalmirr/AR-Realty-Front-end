    ...
    <Fragment>
      {path !== '/users/login' ? (
        <Link href={links.login}>
          <a className='mr-4'>
            <button className='bg-accentDark hover:text-gray-100 hover:bg-gray-400 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline'>
              Log in
            </button>
          </a>
        </Link>
