      ...
      <div className='mx-auto py-12 px-4 sm:py-12 sm:px-6 lg:px-8'>
        <div className='text-center mb-2'>
          ...
          <p className='max-w-xl mt-5 mx-auto text-xl dark:text-textColor-100 text-gray-500'>
            ...
            what we aspire to be. They influence our business decisions and how
            we ultimately serve our customers.
          </p>
        </div>
      </div>
      ...
      <div className='mx-auto py-16 px-4 sm:py-12 sm:px-6 lg:px-8'>
        <div className='text-center'>
          ...
          <p className='max-w-xl mt-5 mx-auto text-md dark:text-textColor-100 text-gray-500'>
            ...
            algorithm, combined with advanced technology, content and
            connections, has turned AR Realty into a household name. This was
            phase one. Despite the transparency that&apos;s empowered millions
            of people in their home journey, very little innovation has happened
            around the transaction itself. We now live in an always-on world,
            but real estate isn&apos;t always on. In fact, it&apos;s off a lot
            of the time. Other industries have ushered in a new era of
            convenience; the time for a seamless and convenient real estate
            transaction experience is now. This is phase two — and our next
